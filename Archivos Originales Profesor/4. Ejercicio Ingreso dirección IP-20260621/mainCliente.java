...
public class mainCliente {
  public static void main(String[] args)  throws IOException {
   ...
   Scanner ent_consola = new Scanner(System.in);
   String ipDestino;
   System.out.println("Ingrese la ip destino (xxx.xxx.xxx.xxx): ");
   ipDestino=ent_consola.nextLine();	
   
 try {
      socketCliente = new Socket(ipDestino, 4444);
